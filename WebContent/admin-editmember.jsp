	...
	<div id="content" class="container">
		<div class="row margin-vert-30">
			<div class="row margin-vert-30">
				<!-- Register Box -->
				<div class="col-md-12">
					<form class="signup-page" action="EditMemberServlet" method="post">
							...
							<div class="col-md-6 col-md-offset-3">
								...
								<table class="table table-hover">
									<tr>
										...
										<td><input class="form-control" type="text"
											...
											value="<%=listmember.getOwner().getOwnerFirstname()%>"></td>
									...
									<tr>
										...
										<td><input class="form-control" type="text"
											...
											value="<%=listmember.getUsername()%>"></td>
									</tr>
									<tr>
										<td><label>รหัสผ่าน <span class="color-red">*</span></label></td>
										<td><input class="form-control" type="password"
											name="password" id="password"
											value="<%=listmember.getPassword()%>"></td>
									</tr>
									<tr>
										<td colspan="2"><label>สถานะการเข้าใช้งาน <span
												class="color-red">*</span></label> <select name="status" id="status"
											class="form-control">
												<%
													if (listmember.getOwner().getStatusapprove() == 0 ) {
												%>
												<option value="0">สมาชิกใหม่</option>
												<option value="1">สมาชิกที่ไม่ได้ออนไลน์</option>
												<option value="2">สมาชิกที่ออนไลน์</option>					
												<%
								...
								<div class="row">
									<div class="col-lg-12 text-right">
										...
										<a href="ListMemberServlet"  class="btn btn-danger" >ยกเลิก</a>
									</div>
								</div>
							</div>
						</div>
