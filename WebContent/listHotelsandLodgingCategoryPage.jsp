...
<%
	Vector<SubCategoryHotel> vHotel = (Vector<SubCategoryHotel>) session.getAttribute("ListHotel");
%>
...
<body>
	...
	<%try{ %>
		<!-- Projects Row -->
		<div class="row">
			<%	for (int i = 0; i < vHotel.size(); i++) {%>
			<div class="col-md-4 text-center">
				<div class="thumbnails">
					<a
						href="ListHotelsandSubCategoryServlet?HotelSubID=<%=vHotel.get(i).getSubcategoryhotelID()%>">
						<img class="img-responsives"
						src="Tools/images/category/SubHotel_0<%=i+1%>.jpg"
						alt="" width="100%">
					</a>
					<div class="caption">
						<h3 align="center">
							<a
								href="ListHotelsandSubCategoryServlet?HotelSubID=<%=vHotel.get(i).getSubcategoryhotelID()%>"><%=vHotel.get(i).getSubcategoryhotelName()%></a>
						</h3>
					</div>
				</div>
			</div>
